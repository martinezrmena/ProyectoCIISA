CREATE TABLE [ENCABEZADORECIBO](
	...
	--[FECHA_CREA]			[DATETIME] NULL CONSTRAINT [DF_ENCABEZADORECIBO_FECHA_CREA] DEFAULT GETDATE(),
	[FECHA_CREA]			[DATETIME] NULL CONSTRAINT [DF_ENCABEZADORECIBO_FECHA_CREA] DEFAULT (DATETIME('NOW','LOCALTIME')),
 ...
 CONSTRAINT [PK_ENCABEZADORECIBO] PRIMARY KEY([NO_CIA], [NO_TRANSA], [TIPO_DOC])
)
...
namespace CIISA.RetailOnLine.Aplicacion.SettlementOnLine.Vista
{
    ...
    public partial class vistaReimpresionAntiguedad : ContentPage
    {
        private ctrlReimpresionAntiguedad controlador = null;

        internal SimulateClickGestures simulateClickGestures = new SimulateClickGestures();

        public vistaReimpresionAntiguedad()
        {
            controlador = new ctrlReimpresionAntiguedad(this);

...
{
    public class reporteInventarioConExistencias
    {
        private ProcesoImpresion v_procesoImpresion { get; set; }

        public reporteInventarioConExistencias(ProcesoImpresion pprocesoImpresion)
        {
            v_procesoImpresion = pprocesoImpresion;
        }

        internal async Task imprimirReporteInventarioConExistencias(string ptituloReporte)
        {
            ...
            _title.titleGenericReport(v_procesoImpresion.v_listaLineasImpresion, ptituloReporte);
            ...
            _manager.buscarLineasInventarioConExistencias(v_procesoImpresion.v_listaLineasImpresion);

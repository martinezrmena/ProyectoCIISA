...
{
    public class reporteCuentasBancarias
    {
        private ProcesoImpresion v_procesoImpresion { get; set; }

        public reporteCuentasBancarias(ProcesoImpresion pprocesoImpresion)
        {
            v_procesoImpresion = pprocesoImpresion;
        }

        internal async Task imprimirReporteCuentasBancarias()
        {
            ...
            _title.titleGenericReport(v_procesoImpresion.v_listaLineasImpresion, "CUENTAS BANCARIAS");
            ...
            _segmentoEncabezado.encabezadoCuentasBancarias(v_procesoImpresion.v_listaLineasImpresion);

            _line.doubleHypenLine(v_procesoImpresion.v_listaLineasImpresion);

            Impresion_ManagerBanco _manager = new Impresion_ManagerBanco();

            _manager.buscarLineasCuentasBancarias(v_procesoImpresion.v_listaLineasImpresion);

...
{
    internal class HelperCargaDatosTablaPrecioCliente
    {
        internal async Task cargaTablaPrecioCliente(
            ...
            )
        {
            ...
            {
                HelperPrecioCliente _helper = new HelperPrecioCliente();

                StringBuilder _sb = _helper.insertTablaPrecioCliente(_fila);

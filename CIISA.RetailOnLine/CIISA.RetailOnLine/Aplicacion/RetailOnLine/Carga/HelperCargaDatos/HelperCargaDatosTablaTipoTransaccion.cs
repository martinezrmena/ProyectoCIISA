...
{
    internal class HelperCargaDatosTablaTipoTransaccion
    {
        internal async Task cargaTablaTipoTransaccion(
            ...
            Log plog)
        {
            ...
            foreach (DataRow _fila in pdt.Rows)
            {
                ...
                StringBuilder _sb = _helper.insertTablaTipoTransaccion(_fila);

...
{
    internal class HelperCargaDatosTablaEncabezadoPedido
    {
        internal async Task cargaTablaEncabezadoPedido(
            ...
            )
        {
            ...
            foreach (DataRow _fila in pdt.Rows)
            {
                ...
                StringBuilder _sb = _helper.insertTablaEncabezadoPedido(_fila);

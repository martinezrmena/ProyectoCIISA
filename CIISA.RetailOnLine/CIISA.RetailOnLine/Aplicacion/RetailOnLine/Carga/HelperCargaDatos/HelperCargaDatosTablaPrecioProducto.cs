...
{
    internal class HelperCargaDatosTablaPrecioProducto
    {
        internal async Task cargaTablaPrecioProducto(
            ...
            )
        {
            ...
            foreach (DataRow _fila in pdt.Rows)
            {
                ...
                StringBuilder _sb = _helper.insertTablaPrecioProducto(_fila);

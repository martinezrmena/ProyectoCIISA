...
{
    public class HelperCargaDatosTablaDescuentoGeneral
    {
        internal async Task cargaTablaDescuentoGeneral(
               ...
               )
        {
            ...
            foreach (DataRow _fila in pdt.Rows)
            {
                ...
                StringBuilder _sb = _helper.insertTablaDescuentoGeneral(_fila);
